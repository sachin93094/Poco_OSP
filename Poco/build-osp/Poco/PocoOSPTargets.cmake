...
foreach(_expectedTarget Poco::OSP)
...
# Create imported target Poco::OSP
add_library(Poco::OSP SHARED IMPORTED)

set_target_properties(Poco::OSP PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/root/Jun_unit_Testing/2jul/Poco/OSP/include"
...
set_target_properties(Poco::OSP PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "/root/Jun_unit_Testing/2jul/Poco/build-osp/lib/libPocoOSP.so.71"
...
foreach(_target "Poco::Foundation" "Poco::XML" "Poco::Util" "Poco::Zip" )
